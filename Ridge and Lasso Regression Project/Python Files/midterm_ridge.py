...
Original file is located at
    https://colab.research.google.com/drive/1mY9X6MPF0ivfYOvZR1MFTNoa9tYIYIVC
"""
...
# uses GridSearchCV to find the hyperparameters for the Ridge regression model that produce the best results
...
# uses cross validation of 5 to make sure the Ridge hyperparameters produce a great score among different folds of data
grid_search = GridSearchCV(ridge_reg, param_grid=params_Ridge, cv = 5, n_jobs=-1)
...
samp_sub.to_csv('/content/drive/My Drive/Stat_380/Midterm/submission8.csv', index = False, header=True)